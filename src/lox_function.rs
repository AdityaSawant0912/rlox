...
use crate::{
    environment::Environment, error_type::LoxError, interpreter::Interpreter,
    lox_callable::LoxCallable, lox_instance::LoxInstance, stmt::Stmt, token::LiteralType,
};
...
impl LoxFunction {
    ...
    pub fn bind(&self, instance: Rc<RefCell<LoxInstance>>) -> LiteralType {
        ...
        environment
            .borrow_mut()
            .define("this", &LiteralType::Instance(Rc::clone(&instance)));

        LiteralType::Callable(Rc::new(LoxFunction::new(
        ...
        match &self.declaration {
            Stmt::Function {
                ...
                for (index, param) in params.iter().enumerate() {
                    environment
                        .borrow_mut()
                        .define(&param.lexeme, arguments.get(index).unwrap());
                }
